...
export function createServer(): McpServer {
  ...
  server.registerTool(
    ...
    {
      title: "Ticker",
      description: "Market summary for a pair.",
      inputSchema: z.object( { primary: z.string().describe("Primary currency like btc."), secondary: z.string().describe("Secondary like usd.") }),
