...
import { z } from "zod";
import { ChessComError, dailyPuzzle, formatLeaders, formatProfile, formatPuzzle, formatStats, getPlayer, getStats, leaderboards, LEADERBOARD_CATEGORIES, } from "./api.js";
...
export function createServer() {
    ...
    server.registerTool("daily_puzzle", {
        title: "Daily puzzle",
    ...
    server.registerTool("leaderboards", {
        title: "Leaderboards",
