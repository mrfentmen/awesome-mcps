...
export function createServer() {
    ...
    server.tool("get_categories", "List every trivia category with its id.", {}, async () => {
        try {
    ...
    server.tool("get_questions", "Get trivia questions with answers.", {
