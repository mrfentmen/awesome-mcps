...
export function createServer(): McpServer {
  const server = new McpServer({ name: "open-holidays-mcp", version: "1.0.0" })
  ...
  server.tool("holidays", "Holidays for a country and year.", { country: z.string().describe("ISO country like DE."), year: z.number().describe("Year.") }, async (args) => {
