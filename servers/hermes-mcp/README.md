...
Hermès resale listings aggregated from Fashionphile and Rebag public catalogs (prices in USD). No API key required. Condition/color/material attributes are parsed from Rebag catalog data (Fashionphile does not publish them); condition filters apply to Rebag data only. Not affiliated with or endorsed by Hermès; prices are asking prices, not appraisals.
...
[hermes-mcp](https://github.com/mrfentmen/awesome-mcps/tree/main/servers/hermes-mcp)
