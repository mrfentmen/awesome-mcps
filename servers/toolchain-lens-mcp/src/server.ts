...
export function createServer() {
  ...
  server.registerTool(
    "explain_toolchain",
    {
      title: "Explain toolchain",
      description: "Explain local reproducibility signals and contradictions without returning exact versions, dependency names, or secret values.",
